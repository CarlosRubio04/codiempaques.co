<div class="col-xm-12 col-sm-12 col-md-12 col-lg-12">
    <div class="col-xm-12 col-sm-12 col-md-12 col-lg-12 form-header">
            ...
            <div class="form-group" style="margin-bottom: 0px;">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <textarea required="" id="mensaje1" name="mensaje1" class="form-control" placeholder="Comentario" rows="1" aria-required="true"></textarea>
                    </div>
                </div>
            </div>
            <div class="form-group">
